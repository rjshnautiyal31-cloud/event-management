...
export function DashboardPage({ auth }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col font-sans pb-mobile-nav">
      ...
      {/* 1. App Header with Hamburger Top Menu & #0A2D59 Brand Styling */}
      <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-slate-200/80 px-4 py-2.5 flex items-center justify-between shadow-xs">
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            className="h-9 w-9 rounded-xl bg-slate-100 hover:bg-slate-200 text-[#0A2D59] flex items-center justify-center font-black text-lg transition-all border border-slate-200/80 shadow-2xs active:scale-95"
          ...
          <div className="flex items-center gap-2">
            <div className="h-8 w-8 rounded-xl bg-[#0A2D59] flex items-center justify-center font-black text-white text-base shadow-sm shadow-[#0A2D59]/20">
              Q
            </div>
            <div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={() => auth.logout()}
            className="hidden sm:inline-block rounded-xl bg-slate-100 hover:bg-red-50 hover:text-red-600 transition-colors px-2.5 py-1.5 text-xs text-slate-500 font-semibold border border-slate-200"
          >
            Logout
          </button>
        </div>
          ...
          <div className="relative w-full max-w-xs bg-white h-full shadow-2xl flex flex-col z-10 animate-slide-right overflow-y-auto border-r border-slate-200">
            ...
            <div className="bg-[#0A2D59] text-white p-5 flex items-center justify-between">
              ...
              <button
                ...
                className="h-8 w-8 rounded-full bg-white/10 hover:bg-white/20 text-white flex items-center justify-center font-bold text-sm transition-colors"
            ...
            <div className="p-4 space-y-6 flex-1">
              <div>
                ...
                <div className="space-y-1">
                  <button
                    onClick={() => { setActiveTab("overview"); setHamburgerMenuOpen(false); }}
                  ...
                  <button
                    onClick={() => { setActiveTab("attendees"); setHamburgerMenuOpen(false); }}
                    className={`w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-xs font-bold transition-all ${
                      activeTab === "attendees"
                        ? "bg-[#0A2D59]/10 text-[#0A2D59] border border-[#0A2D59]/20"
                        : "text-slate-700 hover:bg-slate-100"
                  ...
                  >
                    ...
                    {stats && (
                      <span className="bg-[#0A2D59] text-white text-[10px] px-2 py-0.5 rounded-full font-black">
                  ...
                  <button
                    onClick={() => { setActiveTab("gates"); setHamburgerMenuOpen(false); }}
                    className={`w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-xs font-bold transition-all ${
                      activeTab === "gates"
                        ? "bg-[#0A2D59]/10 text-[#0A2D59] border border-[#0A2D59]/20"
                        : "text-slate-700 hover:bg-slate-100"
                  ...
                  >
                    ...
                    <span className="text-[10px] font-extrabold text-slate-400">{gates.length}</span>
                  </button>

                  {isAdmin && (
                    <button
                      onClick={() => { setActiveTab("team"); setHamburgerMenuOpen(false); }}
                      className={`w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-xs font-bold transition-all ${
                        activeTab === "team"
                          ? "bg-[#0A2D59]/10 text-[#0A2D59] border border-[#0A2D59]/20"
                          : "text-slate-700 hover:bg-slate-100"
                    ...
                    >
                      ...
                      <span className="text-[10px] font-extrabold text-slate-400">{staffUsers.length}</span>
                    </button>
                  )}
                </div>
              </div>
                ...
                <div className="space-y-1">
                  {isSuperAdmin && (
                    <Link
                      to="/generator"
                      onClick={() => setHamburgerMenuOpen(false)}
                      className="flex items-center justify-between px-3 py-2.5 rounded-xl text-xs font-bold text-slate-700 hover:bg-slate-100 transition-all"
                    >
                      <span className="flex items-center gap-2.5">
                        <span>🎨</span>
                  ...
                  {isAdmin && (
                    <>
                      <button
                        onClick={() => { setCreateEventModalOpen(true); setHamburgerMenuOpen(false); }}
                        className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-xs font-bold text-[#0A2D59] bg-slate-50 hover:bg-slate-100 transition-all border border-slate-200"
                      >
                        <span>➕</span>
                      ...
                      <button
                        onClick={() => { setWalkInSheetOpen(true); setHamburgerMenuOpen(false); }}
                        className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-xs font-bold text-slate-700 hover:bg-slate-100 transition-all"
                      >
                        <span>📝</span>
                      ...
                      <button
                        onClick={() => { setBulkImportSheetOpen(true); setHamburgerMenuOpen(false); }}
                        className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-xs font-bold text-slate-700 hover:bg-slate-100 transition-all"
                      >
                        <span>📥</span>
            ...
            <div className="p-4 border-t border-slate-200 bg-slate-50">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-xs font-bold text-red-600 bg-red-50 hover:bg-red-100 transition-colors border border-red-200"
              >
                <span>🚪</span>
